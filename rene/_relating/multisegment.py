...
def relate_to_contour(
    ...
    return relate_multisegmental_to_multisegmental(
            ...
            lambda start, end, contour_segments: (
                relate_segment_to_contour_segments(start, end,
                                                   contour_segments, orienteer)
            ),
            lambda start, end, multisegment_segments: (
                relate_segment_to_multisegment_segments(
                        start, end, multisegment_segments, orienteer,
...
def relate_to_polygon(multisegment: hints.Multisegment[hints.Scalar],
                      ...
                      segments_intersector: SegmentsIntersector[hints.Scalar],
                      /) -> Relation:
    return relate_multisegmental_to_polygon(multisegment, polygon, orienteer,
