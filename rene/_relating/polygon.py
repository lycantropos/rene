...
def relate_to_contour(polygon: hints.Polygon[hints.Scalar],
                      ...
                      /) -> Relation:
    return relate_to_multisegmental(polygon, contour, orienteer,
...
def relate_to_multisegment(
    ...
    return relate_to_multisegmental(polygon, multisegment, orienteer,
                                    segments_intersector)
...
def relate_to_multisegmental(
    ...
    if not intersecting_segments_ids:
        ...
        relation = relate_to_segment(polygon, intersecting_segment, orienteer,
                                     segments_intersector)
