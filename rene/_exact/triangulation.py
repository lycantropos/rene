...
class ConstrainedDelaunayTriangulation:
    ...
    def border(self, /) -> hints.Contour[Fraction]:
        ...
        return self._context.contour_cls(
            ...
            else shrink_collinear_vertices(boundary_points, self._context.orient)
        )

    @property
    def triangles(self, /) -> t.Sequence[hints.Contour[Fraction]]:
        contour_cls = self._context.contour_cls
        return [contour_cls(vertices) for vertices in self._raw.triangles_vertices()]
    ...
    def __new__(cls, raw: _RawConstrainedDelaunayTriangulation[Fraction], /) -> te.Self:
...
class DelaunayTriangulation:
    @classmethod
    def from_points(cls, points: t.Sequence[hints.Point[Fraction]], /) -> te.Self:
        return cls(_RawDelaunayTriangulation.from_points(points, cls._context.orient))
