...
impl<Scalar> SymmetricDifference<Empty> for Multisegment<Scalar> {
    type Output = Self;
...
impl<Scalar> SymmetricDifference for &Multisegment<Scalar>
where
    Scalar: Clone + Ord,
    Multisegment<Scalar>: Clone,
...
impl<Scalar> SymmetricDifference<&Contour<Scalar>> for &Multisegment<Scalar>
where
    Scalar: Clone + Ord,
    Multisegment<Scalar>: Clone,
    Operation<Point<Scalar>, SYMMETRIC_DIFFERENCE>: Iterator<Item = Event>
...
impl<Scalar> SymmetricDifference<&Segment<Scalar>> for &Multisegment<Scalar>
where
    Scalar: Clone + Ord,
    Operation<Point<Scalar>, SYMMETRIC_DIFFERENCE>: Iterator<Item = Event>
        + ReduceEvents<Output = Vec<Segment<Scalar>>>
