...
@given(strategies.contours_segments, strategies.indices)
...
@given(strategies.contours_segments, strategies.slices)
...
@given(strategies.contours_segments, strategies.slices, strategies.slices)
