...
compounds = (empty_geometries | _strategies.segments
...
idempotent_maybe_linear_compounds = (empty_geometries
                                     | idempotent_linear_compounds)
...
_closed_idempotent_compounds_strategies: _st.SearchStrategy[
    ...
    _st.sampled_from([idempotent_maybe_linear_compounds,
